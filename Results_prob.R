...
barplot(rbind(PromedioAlarmas_WoA_Pars,PromedioAlarmas_WoA_Pars_st),main="(C) Alarmas diarias promedio",xlab = "Niveles de predicción",col=c("lightseagreen","blue"),ylim = c(0,25),beside = TRUE,names.arg = seq(5,95,5),cex.main=1,ylab="")
...
barplot(rbind(reaction_HA_WoAPars,reaction_HA_WoA_Pars_AICc_30_st),main="(D) Tiempo de reacción promedio",xlab = "Niveles de predicción",col=c("lightseagreen","blue"),ylim = c(0,60),beside = TRUE,names.arg = seq(5,95,5),cex.main=1,ylab="")
